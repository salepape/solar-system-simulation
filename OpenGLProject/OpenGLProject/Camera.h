...
// Abstract camera class that processes input and calculates the corresponding Euler angles, vectors and matrices for OpenGL to use
class Camera
{
public:
	// Camera Attributes
	...
	void ProcessKeyboard(Camera_Movement direction, float deltaTime)
	{
		...
		// User stays at the ground level (xz plane). He can still look at the sky if he wants to.
		//Position.y = 0.0f; 
	}
	...
	// Processe input received from a mouse scroll-wheel event. Only requires input on the vertical wheel-axis
